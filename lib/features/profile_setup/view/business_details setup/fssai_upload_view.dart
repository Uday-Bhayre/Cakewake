...
class FssaiUploadView extends GetView<ProfileSetupController> {
  const FssaiUploadView({super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Obx(() {
                  final file = controller.fssaiCertificateFile.value;
                  return Container(
              ...
              Center(
                child: GestureDetector(
                  onTap: () async {
                    ...
                    if (pickedFile != null) {
                      controller.setFssaiCertificateFile(File(pickedFile.path));
                    }
                  },
                  child: Container(
              ...
              CustomButton(
                text: "Continue",
                onPressed: () {
                  if (controller.fssaiCertificateFile.value == null) {
                    Get.snackbar(
                      'Error',
                      'Please upload a valid FSSAI Certificate before continuing.',
                  ...
                  Get.toNamed('/profile/contract_upload');
                },
              ),
